...
class CeremonyRenderer:
    ...
    def validate_template_variables(
        ...
        internal_vars = {
            "bg_color_0",
            "bg_color_1",  # renderer-provided colors
            "base",
            "n",
            "pos",  # macro params used in fill-in templates
        }
    ...
    def render(self, template_filename: str, data: Dict[str, any], output_path: str) -> bool:
